...
// Source: github.com/int128/goxzst/usecases/archive (interfaces: Interface)
...
import (
	...
	archive "github.com/int128/goxzst/usecases/archive"
	reflect "reflect"
)
...
func (m *MockInterface) Do(arg0 archive.Input) error {
	m.ctrl.T.Helper()
